...
import scalation.modeling.{SymbolicRegression, Regression}
import scalation.modeling.qk
// import scala.runtime.ScalaRunTime.stringOf


@main def SymRegression1(): Unit =
//   println("Hello, World!")
    ...
    val mod = SymbolicRegression (x, y, ox_fname, scala.collection.mutable.Set(-2.0, -1.0, 0.5, 2.0))    // add, intercept, cross-terms and given powers
    // mod.trainNtest ()()                                                 // train and test the model
    // println (mod.summary ())                                            // parameter/coefficient statistics
    mod.trainNtest ()()
    println (mod.summary ())                                  // parameter/coefficient statistics
