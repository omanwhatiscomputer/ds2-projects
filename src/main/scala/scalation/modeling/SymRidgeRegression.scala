...
//  println (s"y = $y")
    ...
    for tech <- SelectionTech.values do 
        ...
        new PlotM (null, rSq.transpose, Regression.metrics, s"R^2 vs n for Symbolic Ridge Regression with $tech", lines = true)
...
//  println (s"y = $y")
    ...
    for tech <- SelectionTech.values do
        ...
        val k = cols.size
        println (s"k = $k, n = ${x.dim2}")
        new PlotM (null, rSq.transpose, Regression.metrics, s"R^2 vs n for Quadratic Ridge Regression with $tech", lines = true)
        println (s"$tech: rSq = $rSq")
    end for
...
//  println (s"y = $y")
    ...
    for tech <- SelectionTech.values do 
        ...
        val k = cols.size
        println (s"k = $k, n = ${x.dim2}")
        new PlotM (null, rSq.transpose, Regression.metrics, s"R^2 vs n for Quadratic X Ridge Regression with $tech", lines = true)
        println (s"$tech: rSq = $rSq")
    end for
...
//  println (s"y = $y")
    ...
    for tech <- SelectionTech.values do 
        ...
        val k = cols.size
        println (s"k = $k, n = ${x.dim2}")
        new PlotM (null, rSq.transpose, Regression.metrics, s"R^2 vs n for Cubic Ridge Regression with $tech", lines = true)
        println (s"$tech: rSq = $rSq")
    end for
...
//  println (s"y = $y")
    ...
    for tech <- SelectionTech.values do 
        ...
        val k = cols.size
        println (s"k = $k, n = ${x.dim2}")
        new PlotM (null, rSq.transpose, Regression.metrics, s"R^2 vs n for Cubic X Ridge Regression with $tech", lines = true)
        println (s"$tech: rSq = $rSq")
    end for
...
//  println (s"y = $y")
    ...
    for tech <- SelectionTech.values do
        ...
        val k = cols.size
        println (s"k = $k, n = ${x.dim2}")
        new PlotM (null, rSq.transpose, Regression.metrics, s"R^2 vs n for Cubic XX Ridge Regression with $tech", lines = true)
        println (s"$tech: rSq = $rSq")
    end for
